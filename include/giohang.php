<?php
//Post chuyển dữ liệu bằng hình thức là from
 if(isset($_POST['themgiohang'])){
 	...
 	//lấy dữ liệu từ sql gio hàng
 	//tăng cái số lượng lên nếu sản phẩm đó có trong giỏ hàng 	
 	...
 	// là 1 chuỗi nên phải cho vào vong2g lập for
 	for($i=0;$i<count($_POST['product_id']);$i++){
 		$sanpham_id = $_POST['product_id'][$i];
 		$soluong = $_POST['soluong'][$i];
 		//nếu số lượng nhỏ hơn 0 thì xóa 
 		if($soluong<=0){
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				...
				if(isset($_SESSION['dangnhap_home'])){
					echo '<p style="color:#000;">Xin chào bạn: <a href="index.php?quanly=giohang&dangxuat=1">Đăng xuất</a></p>';
				}else{
					echo '';
				}
				?>
			...
			?>
				...
				<div class="table-responsive">
					<!- gửi cho chính trang với hình thức là post->
					...
					<table class="timetable_sub">
						...
						while($row_fetch_giohang = mysqli_fetch_array($sql_lay_giohang)){ 
							...
							$i++;
						?>
							<!-- mỗi vòng lập nó sẽ tăng 1 biến i lên -->
							<tr class="rem1">
								<td class="invert"><?php echo $i ?></td>
								<td class="invert-image">
									<a href="single.html">
										<img src="images/<?php echo $row_fetch_giohang['hinhanh'] ?>" alt=" " height="90" class="img-responsive">
									</a>
								</td>
								<!-- update so luong dua vao id-->
								<td class="invert">
