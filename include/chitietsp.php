<!-- khi mình bấm vào sản phẩm nó sẽ xuất hiện id mình lấy id từ đó -->
<?php
	if(isset($_GET['id'])){
		$id = $_GET['id'];
	}else{
	...
	//lấy tất cả dữ liệu từ csdl $id chính là cái id màm ình lấy được 
...
<!-- page -->
	...
	<!-- //page -->
	<?php
	//lấy ra tất cả dữ liệu mà lấy ra được ở tren 
